...
//    }
    ...
    public PagedResponse<OrderResponse> getOrdersByDate(LocalDateTime startDate, LocalDateTime endDate, int page, int size) {
        Pageable pageable = PageRequest.of(page - 1, size);
        Page<Order> orderPage = orderRepository.findByOrderDateBetweenAndStatus(
                startDate, endDate, OrderStatus.Completed, pageable);
